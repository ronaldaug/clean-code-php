...
## မာတိကာ
  ...
  2. [Variables မ်ား](#variables)
     ...
     * [ဒီ viriable ကဘာလဲဆိုတာ တျခား developer ေတြနားလည္ေအာင္ေပးပါ](#avoid-mental-mapping)
     * [မလိုအပ္တဲ့ အပိုစာေတြေရွာင္ပါ](#dont-add-unneeded-context)
     * [default ျဖစ္တဲ့ argument ေတြသံုးပါ။](#use-default-arguments-instead-of-short-circuiting-or-conditionals)
  3. [ႏွိဳင္းယွဥ္ျခင္း](#comparison)
     * [အမ်ိဳးအစားပါႏွိဳင္းယွဥ္ပါ](#use-identical-comparison)
  4. [Functions မ်ား](#functions)
     * [Function arguments (2 or fewer ideally)](#function-arguments-2-or-fewer-ideally)
     * [Functions ဆိုတာတစ္ခုတည္းပဲ အလုပ္လုပ္သင့္တယ္](#functions-should-do-one-thing)
     * [Function နာမည္က သူလုပ္မယ့္အရာကို ေျပာျပေနသလိုျဖစ္ရမယ္ ](#function-names-should-say-what-they-do)
     * [Functions တစ္ခုတည္းကိုအမ်ားႀကီးမလုပ္ေဆာင္ခိုင္းသင့္ပါ](#functions-should-only-be-one-level-of-abstraction)
     * [Flags ေတြကို function parameters အျဖစ္မသံုးပါႏွင့္](#dont-use-flags-as-function-parameters)
     * [Side Effects မ်ားေရွာင္ပါ](#avoid-side-effects)
     * [Global functions မွာသြားမေရးပါႏွင့္](#dont-write-to-global-functions)
     * [Singleton pattern မသံုးပါႏွင့္](#dont-use-a-singleton-pattern)
     * [Encapsulate conditionals ေတြေရွာင္ပါ](#encapsulate-conditionals)
