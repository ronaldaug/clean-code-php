# PHP ရှင်းရှင်းလင်းလင်း ရေးနည်း

## မာတိကာ

  1. [မိတ်ဆက်](#introduction)
  2. [Variables များ](#variables)
     * [အဓိပ္ပါယ်ရှိပြီး ခေါ်ရလွယ်သော variable များ](#use-meaningful-and-pronounceable-variable-names)
     * [အဓိပ္ပါယ်တူနေရင် တိုတာရွေးပါ](#use-the-same-vocabulary-for-the-same-type-of-variable)
     * [ရှာရလွယ်သောနာမည်များရွေးပါ (part 1)](#use-searchable-names-part-1)
     * [ရှာရလွယ်သောနာမည်များရွေးပါ (part 2)](#use-searchable-names-part-2)
     * [နားလည်လွယ်သော virables များရွေးပါ](#use-explanatory-variables)
     * [Nesting အများကြီးကိုရှောင်ပြီး အစောပိုင်းမှာသာ return လုပ်ပါ (part 1)](#avoid-nesting-too-deeply-and-return-early-part-1)
     * [Nesting အများကြီးကိုရှောင်ပြီး အစောပိုင်းမှာသာ return လုပ်ပါ (part 2)](#avoid-nesting-too-deeply-and-return-early-part-2)
     * [ဒီ viriable ကဘာလဲဆိုတာ တခြား developer တွေနားလည်အောင်ပေးပါ](#avoid-mental-mapping)
     * [မလိုအပ်တဲ့ အပိုစာတွေရှောင်ပါ](#dont-add-unneeded-context)
     * [default ဖြစ်တဲ့ argument တွေသုံးပါ။](#use-default-arguments-instead-of-short-circuiting-or-conditionals)
  3. [နှိုင်းယှဉ်ခြင်း](#comparison)
     * [အမျိုးအစားပါနှိုင်းယှဉ်ပါ](#use-identical-comparison)
  4. [Functions များ](#functions)
     * [Function arguments (2 or fewer ideally)](#function-arguments-2-or-fewer-ideally)
     * [Functions ဆိုတာတစ်ခုတည်းပဲ အလုပ်လုပ်သင့်တယ်](#functions-should-do-one-thing)
     * [Function နာမည်က သူလုပ်မယ့်အရာကို ပြောပြနေသလိုဖြစ်ရမယ် ](#function-names-should-say-what-they-do)
     * [Functions တစ်ခုတည်းကိုအများကြီးမလုပ်ဆောင်ခိုင်းသင့်ပါ](#functions-should-only-be-one-level-of-abstraction)
     * [Flags တွေကို function parameters အဖြစ်မသုံးပါနှင့်](#dont-use-flags-as-function-parameters)
     * [Side Effects များရှောင်ပါ](#avoid-side-effects)
     * [Global functions မှာသွားမရေးပါနှင့်](#dont-write-to-global-functions)
     * [Singleton pattern မသုံးပါနှင့်](#dont-use-a-singleton-pattern)
     * [Encapsulate conditionals တွေရှောင်ပါ](#encapsulate-conditionals)
